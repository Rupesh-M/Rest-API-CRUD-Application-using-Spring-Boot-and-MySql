...
public class NewEmpoyee {
    ...
    public NewEmpoyee(Long employee_id, String employee_first_name, String employee_last_name, String employee_Address, String employee_emailID, int employee_department_ID, Date employee_Joining_date) {
    ...
    public NewEmpoyee(String employee_first_name, String employee_last_name, String employee_Address, String employee_emailID, int employee_department_ID, Date employee_Joining_date) {
        Employee_first_name = employee_first_name;
        Employee_last_name = employee_last_name;
        Employee_Address = employee_Address;
        Employee_emailID = employee_emailID;
